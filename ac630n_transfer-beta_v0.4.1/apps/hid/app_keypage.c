...
static const u8 pp_press[7] = {0x07, 0x07, 0x70, 0x07, 0x70, 0x07, 0x01};
static const u8 pp_null[7]  = {0x00, 0x07, 0x70, 0x07, 0x70, 0x07, 0x00};

static const uint8_t key_leftp1[7]  =    {0x07, 0x05, 0xa0, 0x0f, 0x70, 0x03, 0x01};
static const uint8_t key_leftp2[7]  =    {0x07, 0x05, 0xa0, 0x0e, 0x70, 0x03, 0x01};
static const uint8_t key_leftp3[7]  =    {0x07, 0x05, 0x48, 0x0d, 0x70, 0x03, 0x01};
static const uint8_t key_leftp4[7]	=    {0x07, 0x05, 0x1c, 0x0c, 0x70, 0x03, 0x01};
static const uint8_t key_leftp5[7]	=    {0x07, 0x05, 0x1c, 0x0b, 0x70, 0x03, 0x01};
static const uint8_t key_leftp6[7]	=	 {0x07, 0x05, 0xf0, 0x0a, 0x70, 0x03, 0x01};
static const uint8_t key_leftp7[7]	=    {0x07, 0x05, 0xc4, 0x09, 0x70, 0x03, 0x01};
static const uint8_t key_leftp8[7]	=    {0x07, 0x05, 0x98, 0x08, 0x70, 0x03, 0x01};
static const uint8_t key_leftp9[7]	=    {0x07, 0x05, 0x6c, 0x07, 0x70, 0x03, 0x01};
static const uint8_t key_leftp10[7]	=    {0x07, 0x05, 0x40, 0x06, 0x70, 0x03, 0x01};
static const uint8_t key_leftp11[7]	=    {0x07, 0x05, 0x14, 0x05, 0x70, 0x03, 0x01};
static const uint8_t key_leftp12[7]	=    {0x07, 0x05, 0x14, 0x04, 0x70, 0x03, 0x01};
static const uint8_t key_leftp13[7]	=    {0x07, 0x05, 0xe8, 0x03, 0x70, 0x03, 0x01};
static const uint8_t key_left_null[7] =	 {0x00, 0x05, 0xbc, 0x02, 0x70, 0x03, 0x00};



static const uint8_t key_right_reportp1[7] =    {0x07, 0x04, 0x32, 0x00, 0x70, 0x03, 0x01};
static const uint8_t key_right_reportp2[7] =    {0x07, 0x04, 0x32, 0x01, 0x70, 0x03, 0x01};
static const uint8_t key_right_reportp3[7] =    {0x07, 0x04, 0x8a, 0x02, 0x70, 0x03, 0x01};
static const uint8_t key_right_reportp4[7] =    {0x07, 0x04, 0xb6, 0x03, 0x70, 0x03, 0x01};
static const uint8_t key_right_reportp5[7] =    {0x07, 0x04, 0xe2, 0x04, 0x70, 0x03, 0x01};
static const uint8_t key_right_reportp6[7] =    {0x07, 0x04, 0xe2, 0x05, 0x70, 0x03, 0x01};
static const uint8_t key_right_reportp7[7] =    {0x07, 0x04, 0x0e, 0x06, 0x70, 0x03, 0x01};
static const uint8_t key_right_reportp8[7] =    {0x07, 0x04, 0x3a, 0x07, 0x70, 0x03, 0x01};
static const uint8_t key_right_reportp9[7] =    {0x07, 0x04, 0x66, 0x08, 0x70, 0x03, 0x01};
static const uint8_t key_right_reportp10[7] =    {0x07, 0x04, 0x92, 0x09, 0x70, 0x03, 0x01};
static const uint8_t key_right_reportp11[7] =    {0x07, 0x04, 0xbe, 0x0a, 0x70, 0x03, 0x01};
static const uint8_t key_right_reportp12[7] =    {0x07, 0x04, 0xea, 0x0b, 0x70, 0x03, 0x01};
static const uint8_t key_right_reportp13[7] =    {0x07, 0x04, 0xea, 0x0c, 0x70, 0x03, 0x01};
static const uint8_t key_right_report_null[7] =  {0x00, 0x04, 0x16, 0x0d, 0x70, 0x03, 0x00};

static const uint8_t key_up_reportp0[7] =      {0x07, 0x06, 0x70, 0x07, 0x88, 0x0d, 0x01};
static const uint8_t key_up_reportp1[7] =      {0x07, 0x06, 0x70, 0x07, 0x80, 0x0c, 0x01};
static const uint8_t key_up_reportp2[7] =      {0x07, 0x06, 0x70, 0x07, 0x80, 0x0b, 0x01};
static const uint8_t key_up_reportp3[7] =      {0x07, 0x06, 0x70, 0x07, 0x28, 0x0a, 0x01};
static const uint8_t key_up_reportp4[7] =      {0x07, 0x06, 0x70, 0x07, 0x28, 0x09, 0x01};
static const uint8_t key_up_reportp5[7] =      {0x07, 0x06, 0x70, 0x07, 0xfc, 0x08, 0x01};
static const uint8_t key_up_reportp6[7] =      {0x07, 0x06, 0x70, 0x07, 0xd0, 0x07, 0x01};
static const uint8_t key_up_reportp7[7] =      {0x07, 0x06, 0x70, 0x07, 0xa4, 0x06, 0x01};
static const uint8_t key_up_reportp8[7] =      {0x07, 0x06, 0x70, 0x07, 0x78, 0x05, 0x01};
static const uint8_t key_up_reportp9[7] =  	   {0x07, 0x06, 0x70, 0x07, 0x4c, 0x04, 0x01};
static const uint8_t key_up_reportp10[7] =     {0x07, 0x06, 0x70, 0x07, 0x20, 0x03, 0x01};
static const uint8_t key_up_reportp11[7] =     {0x07, 0x06, 0x70, 0x07, 0x4c, 0x02, 0x01};
static const uint8_t key_up_reportp12[7] =     {0x07, 0x06, 0x70, 0x07, 0xf4, 0x01, 0x01};
static const uint8_t key_up_report_null[7] =    {0x00, 0x06, 0x70, 0x07, 0xc8, 0x00, 0x00};


static const uint8_t key_down_reportp0[7]   =      {0x07, 0x06, 0x70, 0x07, 0xf4, 0x01, 0x01};
static const uint8_t key_down_reportp1[7]   =      {0x07, 0x06, 0x70, 0x07, 0xf4, 0x02, 0x01};
static const uint8_t key_down_reportp2[7]   =      {0x07, 0x06, 0x70, 0x07, 0xf4, 0x03, 0x01};
static const uint8_t key_down_reportp3[7]   =      {0x07, 0x06, 0x70, 0x07, 0x4c, 0x04, 0x01};
static const uint8_t key_down_reportp4[7]   =      {0x07, 0x06, 0x70, 0x07, 0x78, 0x05, 0x01};
static const uint8_t key_down_reportp5[7]   =      {0x07, 0x06, 0x70, 0x07, 0xa4, 0x06, 0x01};
static const uint8_t key_down_reportp6[7]   =      {0x07, 0x06, 0x70, 0x07, 0xd0, 0x07, 0x01};
static const uint8_t key_down_reportp7[7]   =      {0x07, 0x06, 0x70, 0x07, 0xfc, 0x08, 0x01};
static const uint8_t key_down_reportp8[7]   =      {0x07, 0x06, 0x70, 0x07, 0xfc, 0x09, 0x01};
static const uint8_t key_down_reportp9[7]   =      {0x07, 0x06, 0x70, 0x07, 0x28, 0x0a, 0x01};
static const uint8_t key_down_reportp10[7]   =     {0x07, 0x06, 0x70, 0x07, 0x54, 0x0b, 0x01};
static const uint8_t key_down_reportp11[7]   =     {0x07, 0x06, 0x70, 0x07, 0x78, 0x0c, 0x01};
static const uint8_t key_down_reportp12[7]   =     {0x07, 0x06, 0x70, 0x07, 0x78, 0x0d, 0x01};
static const uint8_t key_down_report_null[7]  =    {0x00, 0x06, 0x70, 0x07, 0xac, 0x0d, 0x00};

//加delay 2s,长按时间
static const uint8_t key_pp_long_report[7]  =    {0x07, 0x07, 0x70, 0x07, 0x70, 0x07, 0x01}; //压屏==按住键
static const uint8_t key_pp_long_report1[7] =    {0x22, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
static const uint8_t key_pp_long_null[7]    =    {0x00, 0x07, 0x70, 0x07, 0x70, 0x07, 0x00}; //松开==松键

//双击
static const uint8_t key_pp_double_reportp1[7] =    {0x07, 0x07, 0x70, 0x07, 0x70, 0x07, 0x01}; //压屏==按住键
static const uint8_t key_pp_double_reportp2[7] =    {0x00, 0x07, 0x70, 0x07, 0x70, 0x07, 0x00}; //松开==松键
static const uint8_t key_pp_double_reportp3[7] =    {0x07, 0x07, 0x70, 0x07, 0x70, 0x07, 0x01}; //压屏==按住键
static const uint8_t key_pp_double_reportp4[7] =    {0x00, 0x07, 0x70, 0x07, 0x70, 0x07, 0x00}; //松开==松键


static const uint8_t key_one_report1[7] =    {0x07, 0x08, 0x00, 0x08, 0xA4, 0x0C, 0x01}; //压屏==按住键
static const uint8_t key_one_report2[7] =    {0x00, 0x08, 0x00, 0x08, 0xA4, 0x0C, 0x00}; //松开==松键


static const uint8_t key_one_long_reportp1[7]    =  {0x07, 0x08, 0x00, 0x08, 0xA4, 0x0C, 0x01};
static const uint8_t key_one_long_reportp2[7]    =  {0x22, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}; //加delay 2s
static const uint8_t key_one_long_report_null[7] =  {0x00, 0x08, 0x00, 0x08, 0xA4, 0x0C, 0x00};


static const uint8_t key_one_double_report1[7] =     {0x07, 0x08, 0x00, 0x08, 0xA4, 0x0C, 0x01};
static const uint8_t key_one_double_report2[7] =     {0x00, 0x08, 0x00, 0x08, 0xA4, 0x0C, 0x00};
static const uint8_t key_one_double_report3[7] =     {0x07, 0x08, 0x00, 0x08, 0xA4, 0x0C, 0x01};
static const uint8_t key_one_double_report_null[7] = {0x00, 0x08, 0x00, 0x08, 0xA4, 0x0C, 0x00};


static const uint8_t key_volume_increase[3]         =  {0x02, 0x00, 0x00};
static const uint8_t key_volume_increase_null[3]    =  {0x00, 0x00, 0x00};
static const uint8_t key_volume_dec[3]              =  {0x01, 0x00, 0x00};
static const uint8_t key_volume_dec_null[3]         =  {0x00, 0x00, 0x00};

#define KEY_DELAY_TIME()  os_time_dly(1)
...
static void app_key_deal_test(u8 key_type, u8 key_value)
{
    ...
    if (key_type == KEY_EVENT_CLICK) {
        if (key_value == 0) {
            hid_data_send_pt(1, pp_press, 7);
            hid_data_send_pt(1, pp_null, 7);
        } else if (key_value == 3) {
            hid_data_send_pt(1, key_down_reportp0, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_down_reportp1, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_down_reportp2, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_down_reportp3, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_down_reportp4, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_down_reportp5, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_down_reportp6, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_down_reportp7, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_down_reportp8, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_down_reportp9, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_down_reportp10, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_down_reportp11, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_down_reportp12, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_down_report_null, 7);

        }

        else if (key_value ==  2) {
            hid_data_send_pt(1, key_leftp1, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_leftp2, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_leftp3, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_leftp4, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_leftp5, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_leftp6, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_leftp7, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_leftp8, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_leftp9, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_leftp10, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_leftp11, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_leftp12, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_leftp13, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_left_null, 7);

        } else if (key_value  == 1) {
            hid_data_send_pt(1, key_right_reportp1, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_right_reportp2, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_right_reportp3, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_right_reportp4, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_right_reportp5, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_right_reportp6, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_right_reportp7, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_right_reportp8, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_right_reportp9, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_right_reportp10, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_right_reportp11, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_right_reportp12, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_right_reportp13, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_right_report_null, 7);

        } else if (key_value == 4) {
            hid_data_send_pt(1, key_up_reportp0, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_up_reportp1, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_up_reportp2, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_up_reportp3, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_up_reportp4, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_up_reportp5, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_up_reportp6, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_up_reportp7, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_up_reportp8, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_up_reportp9, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_up_reportp10, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_up_reportp11, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_up_reportp12, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_up_report_null, 7);
        }
    }

    if (key_type == KEY_EVENT_DOUBLE_CLICK) {
        if (key_value == 0) {
            hid_data_send_pt(1, key_pp_double_reportp1, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_pp_double_reportp2, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_pp_double_reportp3, 7);
            KEY_DELAY_TIME();
            hid_data_send_pt(1, key_pp_double_reportp4, 7);
            KEY_DELAY_TIME();
        }
        /*
           else if(key_value == 1)
           {
           hid_data_send_pt(1,key_one_double_report1,7);
           hid_data_send_pt(1,key_one_double_report2,7);
           hid_data_send_pt(1,key_one_double_report_null,7);
           }
           else if(key_value == 3){
           hid_data_send_pt(3,key_volume_increase,3);
           hid_data_send_pt(3,key_volume_increase_null,7);

           }
           else if(key_value == 4){
           hid_data_send_pt(3,key_volume_dec,3);
           hid_data_send_pt(3,key_volume_dec_null,3);
